...
extern class Debug {
	...
	function spriteInputInfo (sprite:phaser.gameobjects.Sprite, x:Float, y:Float, ?color:String = 'rgb(255,255,255)'):Void;
	...
	function spriteBounds (sprite:phaser.gameobjects.Sprite, ?color:String, ?filled:Bool = true):Void;
	function spriteInfo (sprite:phaser.gameobjects.Sprite, x:Float, y:Float, ?color:String = 'rgb(255,255,255)'):Void;
	function spriteCoords (sprite:phaser.gameobjects.Sprite, x:Float, y:Float, ?color:String = 'rgb(255,255,255)'):Void;
	...
	function geom (object:phaser.geom.Rectangle, ?color:String, ?filled:Bool = true, ?forceType:Float = 0):Void;
