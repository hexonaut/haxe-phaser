...
extern class GameObjectCreator {
	 ...
	 */
	function graphics (?x:Float = 0, ?y:Float = 0):phaser.gameobjects.Graphics;
	 ...
	 */
	function bitmapText (x:Float, y:Float, font:String, ?text:String = '', ?size:Float = 32, ?align:String = 'left'):phaser.gameobjects.BitmapText;
