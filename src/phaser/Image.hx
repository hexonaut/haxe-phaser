...
*/
@:native("Phaser.Image")
extern class Image extends pixi.Sprite {
	...
	*/
	@:native("position")
	var Image_position:phaser.Point;
	...
	*/
	function bringToTop():phaser.Image;
	...
	* @return This instance.
	*/
	function moveDown():phaser.Image;
	...
	* @return This instance.
	*/
	function reset(x:Float, y:Float, ?health:Float):phaser.Image;
	...
	* @return This instance.
	*/
	function revive(?health:Float):phaser.Image;
	...
	* @return This instance.
	*/
	function sendToBack():phaser.Image;
