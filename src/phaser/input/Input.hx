...
extern class Input {
	 ...
	 */
	@:overload(function (displayObject:phaser.gameobjects.Sprite, pointer:Dynamic):phaser.geom.Point {})
	function getLocalPosition (displayObject:phaser.gameobjects.Image, pointer:Dynamic):phaser.geom.Point;
