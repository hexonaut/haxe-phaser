...
*/
@:native("Phaser.Rope")
extern class Rope extends pixi.Rope {
	...
	*/
	function new(game:phaser.Game, x:Float, y:Float, key:EitherType<String, EitherType<phaser.RenderTexture, EitherType<phaser.BitmapData, EitherType<pixi.Texture, phaser.Video>>>>, ?frame:EitherType<String, Float>, ?points:Array<phaser.Point>);
	...
	*/
	var key:EitherType<String, EitherType<phaser.RenderTexture, EitherType<phaser.BitmapData, EitherType<pixi.Texture, phaser.Video>>>>;
	...
	*/
	...
	@:native("points")
	var Rope_points:Array<phaser.Point>;
	...
	*/
	@:native("position")
	var Rope_position:phaser.Point;
	...
	*/
	var segments:Array<phaser.Rectangle>;
	...
	*/
	function bringToTop():phaser.Rope;
	...
	*/
	function checkTransform(wt:pixi.Matrix):Void;
	...
	*/
	function crop(rect:phaser.Rectangle, ?copy:Bool):Void;
	...
	* @return This instance.
	*/
	function reset(x:Float, y:Float, ?health:Float):phaser.Rope;
	...
	* @return This instance.
	*/
	function revive(?health:Float):phaser.Rope;
	...
	* @return This instance.
	*/
	function sendToBack():phaser.Rope;
	...
	*/
	function setScaleMinMax(?minX:Float, ?minY:Float, ?maxX:Float, ?maxY:Float):Void;
