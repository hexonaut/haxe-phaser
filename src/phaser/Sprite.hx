...
extern class Sprite extends pixi.Sprite {
	...
	*/
	function new(game:phaser.Game, x:Float, y:Float, ?key:EitherType<String, EitherType<phaser.RenderTexture, EitherType<phaser.BitmapData, pixi.Texture>>>, ?frame:EitherType<String, Float>);
	...
	*/
	@:native("anchor")
	var Sprite_anchor:phaser.Point;
	...
	*/
	@:native("position")
	var Sprite_position:phaser.Point;
	...
	* Default: null
	*/
	var tintedTexture:HTMLCanvasElement;
	...
	*/
	function bringToTop():phaser.Sprite;
	...
	*/
	...
	function damage(amount:Float):phaser.Sprite;
	...
	*/
	...
	function heal(amount:Float):phaser.Sprite;
	...
	* @return This instance.
	*/
	function moveDown():phaser.Sprite;
	...
	* @return This instance.
	*/
	function reset(x:Float, y:Float, ?health:Float):phaser.Sprite;
	...
	* @return This instance.
	*/
	function revive(?health:Float):phaser.Sprite;
	...
	* @return This instance.
	*/
	function sendToBack():phaser.Sprite;
